...
interface ProductNotSharedFilterProps {
    onFilterChange: (filterParams: FilterParams) => void;
}

const ProductNotSharedFilter: React.FC<ProductNotSharedFilterProps> = ({ onFilterChange }) => {
    ...
    }, [search, stockID, sortBy, onFilterChange]);
...
export default ProductNotSharedFilter;