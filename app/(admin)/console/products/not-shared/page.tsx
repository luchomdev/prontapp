...
import ProductNotSharedFilter from '@/app/(admin)/components/Products/ProductNotSharedFilter';
...
import { 
    fetchProductsNotSharedServer,
    importProductNotSharedServer 
} from '@/app/(admin)/actions/productsNotShared';
...
const ProductsNotSharedPage = () => {
    ...
    const fetchProducts = useCallback(async (loadMore = false) => {
        ...
        try {
            const data = await fetchProductsNotSharedServer(currentPage, filterParams);
    ...
    const handleImport = useCallback(async (product: MegaProduct) => {
        ...
        try {
            const success = await importProductNotSharedServer(product);
    ...
    return (
        <div className="p-6">
            ...
            <h1 className="text-sm font-bold mb-6">Productos No Compartidos</h1>
            <ProductNotSharedFilter onFilterChange={handleFilterChange} />
...
export default ProductsNotSharedPage;