...
const CashTransactionInfo: React.FC<CashTransactionInfoProps> = ({ orderIds, totalValue }) => {
  ...
  return (
    <div className="border-t border-gray-200 pt-4 mt-4">
      ...
      <p className="mb-4 font-semibold">El valor a pagar contraentrega es de {formatCurrency(totalValue)}, incluyendo el valor del envío</p>
      <p className="mb-2">Para ver tus pedidos:</p>
      <Link href="/panel/orders" className="inline-block bg-orange-500 text-white font-bold py-2 px-4 rounded hover:bg-orange-600 transition duration-300">
        Ir a mis pedidos
      </Link>
    </div>
  );
